...
enum eConfigUInt32Values
{
    ...
    // End Achievements Defines
#endif
    CONFIG_UINT32_DUAL_SPEC_ITEM_ID,
    CONFIG_UINT32_DUAL_SPEC_COST,
    //Start Immersive Defines
    CONFIG_UINT32_IMMERSIVE_MANUAL_ATTR_PCT,
    CONFIG_UINT32_IMMERSIVE_MANUAL_ATTR_INCREASE,
    CONFIG_UINT32_IMMERSIVE_MANUAL_ATTR_COST_MULT,
    CONFIG_UINT32_IMMERSIVE_MANUAL_ATTR_MAX_POINTS,
    CONFIG_UINT32_IMMERSIVE_SHARED_XP_PCT,
    CONFIG_UINT32_IMMERSIVE_SHARED_REP_PCT,
    CONFIG_UINT32_IMMERSIVE_SHARED_MONEY_PCT,
    CONFIG_UINT32_IMMERSIVE_SHARED_PCT_RACE_RESTR,
    CONFIG_UINT32_IMMERSIVE_SHARED_PCT_CLASS_RESTR,
    CONFIG_UINT32_IMMERSIVE_SHARED_PCT_MIN_LVL,
    CONFIG_UINT32_IMMERSIVE_ATTR_LOSS_PER_DEATH,
    CONFIG_UINT32_IMMERSIVE_SHARED_RANDOM_PCT,
    //End Immersive Defines
...
enum eConfigInt32Values
{
    ...
    CONFIG_INT32_IMMERSIVE_SHARED_XP_PCT_LEVEL_DIFF,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_HARDCORE_BOT_DROP_GEAR,
    CONFIG_FLOAT_HARDCORE_BOT_DROP_ITEMS,
    CONFIG_FLOAT_HARDCORE_BOT_DROP_MONEY,
    //End Hardcore Defines
    //Start Immersive Defines
    CONFIG_FLOAT_IMMERSIVE_FALL_DAMAGE_MULT,
    //End Immersive Defines
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_LFG_TELEPORT,
    CONFIG_BOOL_WAREFFORT_ENABLE,
    //Start Solocraft Defines
